#
# Be sure to run `pod lib lint XHMagicRecordCamera.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'XHMagicRecordCamera/Classes/**/*'
  
  # s.resource_bundles = {
  #   'XHMagicRecordCamera' => ['XHMagicRecordCamera/Assets/*.png']
  # }

  # s.public_header_files = 'Pod/Classes/**/*.h'
  s.frameworks = 'UIKit', 'MapKit', 'OpenGLES'
